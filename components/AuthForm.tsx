    ...
    <section className="auth-form">
        ...
        {user ? (
            ...
            <Form {...form}>
                    ...
                    <div className="flex flex-col gap-4">
                    <Button type="submit" disabled={isLoading} //So that users dont click multiple times and spem your database
                        className='form-btn'
                        >
                            {isLoading ? (
                                <>
